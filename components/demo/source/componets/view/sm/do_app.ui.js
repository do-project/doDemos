...
bn_openPage.on("touch",function(data, e){
	app.openPage({source:"source://componets/view/sm/do_appdemo.ui", data:do_textfield_id.text, animationType:"fade", isFullScreen:false, keyboardMode:"default", scriptType:""}, function(data, e){});
});
var a;
