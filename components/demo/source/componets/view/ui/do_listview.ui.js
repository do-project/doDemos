...
listview.on("touch",function(data, e){
	app.openPage({source:"source://componets/view/ui/listviewdemo.ui", data:data, animationType:"", isFullScreen:false, keyboardMode:"default", scriptType:""}, function(data, e){});
});
