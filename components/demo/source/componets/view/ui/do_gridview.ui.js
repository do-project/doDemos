...
var _datas = [
              {"img":"source://componets/image/p/1.jpg"},
              {"img":"source://componets/image/p/2.jpg"},
              {"img":"source://componets/image/p/3.jpg"},
              {"img":"source://componets/image/p/4.jpg"},
              {"img":"source://componets/image/p/1.jpg"},
              {"img":"source://componets/image/p/2.jpg"},
              {"img":"source://componets/image/p/3.jpg"},
              {"img":"source://componets/image/p/4.jpg"},
              {"img":"source://componets/image/p/5.jpg"}
             ]
...
listdata.addOne({ "$+" : "+", "$0" : "source://componets/image/img@add.png"}, 0);
gridview.refreshItems();

var rootview, menuor;
rootview = ui("$");
menuor = ui(rootview.add("menuor", "source://componets/view/kit/menu.ui", 0, 0));
var i ;
...
page.on("image-touched", function(source){
    if (source != "source://componets/image/img@add.png"){
    	imageBrowser.show([
			{ "source" : source}
		]);
    }
